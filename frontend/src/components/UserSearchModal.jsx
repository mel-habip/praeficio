...
export default function UserSearchModal({ is_open, user, set_is_open, add_button_text = 'Add User', button_function = () => { }, setIsLoggedIn }) {
    ...
    useEffect(() => {
        ...
        const delayDebounceFn = setTimeout(() => {
            ...
            axios.post(`https://${process.env.REACT_APP_BUILD_ENV}.praeficio.com/be/api/search`, { type: 'User', keyword, columns: ['username', 'first_name', 'last_name', 'email', 'user_id'] }).then(response => {
